...
export const FormStep3 = () => {
  ...
  return (
    <>
      <div className='overflow-hidden pt-[163px] lg:pt-0 lg:pr-0 lg:pl-0 lg:overflow-auto lg:h-[calc(100vh_-_36px)] w-full text-center text-white lg:block flex flex-col justify-center'>
        <div className='flex-1'>
          ...
          <h1 className='text-[2.5rem] lg:text-5xl leading-[3rem] font-impact font-normal uppercase max-w-[17rem] lg:max-w-[30rem] lg:leading-snug m-auto mt-11 lg:mt-6'>Ya estás participando en el sorteo</h1>
